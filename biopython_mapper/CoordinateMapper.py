# Taken from https://raw.githubusercontent.com/lennax/biopython/f_loc5/Bio/SeqUtils/Mapper/CoordinateMapper.py 
...
from biopython_mapper import GenomePosition, CDSPosition, ProteinPosition

#from Bio.SeqUtils.Mapper.MapPositions import CDSPositionError, \
#        ProteinPositionError
from biopython_mapper.MapPositions import CDSPositionError, \
        ProteinPositionError

#from Bio.SeqUtils.Mapper import MapPositions  # for decorator
from biopython_mapper import MapPositions  # for decorator
